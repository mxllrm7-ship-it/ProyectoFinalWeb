...
export const editarPerfilUsuario = async ({ id_usuario, nombre_usuario, email_usuario, telefono, username, foto_rostro }) => {
  const payload = new EditarPerfilPayload({ id_usuario, nombre_usuario, email_usuario, telefono, username, foto_rostro })
